const c3: string[] = ["aba", "act", "age", "ala", 	"ant", 	"ape", 	"arc", 	"art", 	"bat", 	"bin", 	"but", 	"cot", 	"dew", 	"dry", 	"end", 	"fly", 	"gin", 	"her", 	"icy", 	"jet", 	"jun", 	"log", 	"mon", 	"nil", 	"orb", 	"pet", 	"rad", 	"rim", 	"rum" ];
...
const genRanWord = (wordArray:any) =>{
...
const words  = (char: number) => {
  ...
  switch (char) {
    case 4:
      return genRanWord(c4);
      break;
    case 5:
      return genRanWord(c5);
      break;
    case 6:
      return genRanWord(c6);
      break;
    case 7:
      return genRanWord(c7);
      break;
    default:
      return genRanWord(c3);
      break;
  }
}
